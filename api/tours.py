...
async def list_tours(
    ...
    items = svc.list(group=workspace_id, tour_type=tour_type)
    return items
...
async def generate_tour_presigned_urls(tour_id: str, files: list, svc: TourService = Depends(get_tour_service)):
