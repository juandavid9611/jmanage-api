...
class CognitoIdentityProviderWrapper:
    ...
    def sign_up_user(self, password, user_email, name):
        """
        ...
        try:
            ...
            if err.response["Error"]["Code"] == "UsernameExistsException":
                response = self.cognito_idp_client.admin_get_user(
                    UserPoolId=self.user_pool_id, Username=user_email
                )
                logger.warning(
                    "User %s exists and is %s.", user_email, response["UserStatus"]
                )
            else:
                logger.error(
    ...
    def update_user_field(self, user_email, field, value):
        ...
        : param user_email: The email address of the user to update.
        ...
        try:
            ...
            logger.error(
                "Couldn't update user %s. Here's why: %s: %s",
                user_email,
                err.response["Error"]["Code"],
                err.response["Error"]["Message"],
            )
    ...
    def get_user(self, user_name):
        """
        Gets information about a user from the user pool.

        :param user_name: The name of the user to get information about.
